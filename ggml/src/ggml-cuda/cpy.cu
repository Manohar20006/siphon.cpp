...
// TQ3_0 -> F32: single-thread dequant (3-bit codebook + inverse WHT) for the CPY path
...
// TQ3_0 -> F16: dequant straight to half (avoids the F32 intermediate; halves the FA dequant transient)
