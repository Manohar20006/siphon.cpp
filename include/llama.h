...
extern "C" {
    ...
    struct llama_model_params {
        ...
        bool dstorage_moe;    // stream Qwen MoE experts from SSD to GPU cache slots

        uint32_t moe_gpu_cache_mib; // DirectStorage MoE GPU cache budget
        uint32_t moe_pinned_cache_mib; // pinned host RAM budget for the MoE L2 cache
    };
    ...
    struct llama_context_params {
        ...
        bool dstorage_moe; // enable DirectStorage MoE eval callback
        bool dstorage_moe_prefetch; // speculatively prefetch future-layer experts from previous-token routing
